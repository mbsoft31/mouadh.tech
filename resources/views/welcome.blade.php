        ...
        <div
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/25">
                    ...
                    <div class="py-6">
                        <a href="{{ route('login') }}" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-gray-800">Login</a>
                    </div>
                </div>
            </div>
        </div>
...
<main>
        ...
        <div class="relative overflow-hidden pt-16">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <img src="https://tailwindui.com/plus/img/component-images/project-app-screenshot.png"
                     alt="App screenshot" class="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-gray-900/10" width="2432"
                     height="1442">
    ...
    <div class="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl sm:text-center">
            ...
            <p class="mt-6 text-lg/8 text-gray-600">Choose an affordable plan that’s packed with the best features for
                ...
                <div class="pt-6">
                  ...
                  <svg class="hidden size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                    ...
                    <dd class="mt-2 pr-12" id="faq-0">
                        <p class="text-base/7 text-gray-600">I don&#039;t know, but the flag is a big plus. Lorem ipsum
